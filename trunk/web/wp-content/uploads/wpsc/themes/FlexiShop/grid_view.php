...
<?php
	...
	if(get_option('grid_number_per_row') > 0) {
			$products = get_option('grid_number_per_row');
	}
	else {
                ...
                <form class='product_form'  enctype="multipart/form-data" action="<?php echo wpsc_this_page_url(); ?>" method="post" name="product_<?php echo wpsc_the_product_id(); ?>" id="product_<?php echo wpsc_the_product_id(); ?>" >
                    ...
                    <div class="padding">
						...
						<div class="producttext">
							...
							<?php if(get_option('display_description') == 1) : ?>
							...
							<?php if(get_option('display_moredetails') == 1) : ?>
								<p><a href='<?php echo wpsc_the_product_permalink(); ?>'><?php _e( 'More Details', 'flexishop' ); ?></a></p>
							<?php endif; ?> 
							...
							<?php if( (get_option('display_addtocart') == 1) ) :?> 	   
							...
							<?php echo '<p>'.wpsc_edit_the_product_link().'</p>'; ?>
