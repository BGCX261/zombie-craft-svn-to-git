...
public abstract class EntityLiving extends Entity
{
    ...
    public boolean canEntityBeSeen2(Entity entity)
    {
        ...
        return worldObj.rayTraceBlocks_do(Vec3D.createVector(posX, posY-yOffset+0.7, posZ), Vec3D.createVector(entity.posX, entity.posY-entity.yOffset+0.7, entity.posZ), false) == null;
    }
    ...
    public boolean canEntityBeSeen4(Entity entity)
    {
        ...
        return (worldObj.rayTraceBlocks_do(Vec3D.createVector(posX, posY-yOffset+0.7, posZ), Vec3D.createVector(entity.posX, entity.posY-entity.yOffset+0.7, entity.posZ), false) == null && MathHelper.abs((float)((posY-yOffset) - (entity.posY-entity.yOffset))) < 1.1F);
    }
    
  //
    public boolean canSeeNode(Entity entity)
    {
        return (worldObj.rayTraceBlocks_do(Vec3D.createVector(posX, posY-yOffset+0.5, posZ), Vec3D.createVector(entity.posX, entity.posY-entity.yOffset, entity.posZ), false) == null);
    }
    ...
    // TODO New function to not break everything
    ...
    {
    	if(entity instanceof EntityFriend && (this instanceof EntityPlayer || this instanceof EntityFriend)) {
    		return false;
    	}
        ...
        if(flag)
        {
            ...
            if(entity != null)
            {
                ...
                if (this instanceof EntityMobs) { knockBack(entity, i, d, d1); }
            } else
            {
    ...
    public void readEntityFromNBT(NBTTagCompound nbttagcompound)
    {
        ...
        /*if (health < 1 && (this instanceof EntityPlayer) && !mod_EntAI.autoRespawn) {
        	((EntityPlayer)this).respawnPlayer();
        	//health = 20;
        	mod_EntAI.autoRespawn = true;
        }*/
    }
