...
public class BlockDoor extends Block
{
    ...
    public boolean canPlaceBlockAt(World world, int i, int j, int k)
    {
        ...
        {
        	//System.out.println("-----");
        	/*System.out.println(world.isBlockOpaqueCube(i, j - 1, k));
        	System.out.println(super.canPlaceBlockAt(world, i, j, k));
        	System.out.println(super.canPlaceBlockAt(world, i, j + 1, k));*/
        	//System.out.println("======");
