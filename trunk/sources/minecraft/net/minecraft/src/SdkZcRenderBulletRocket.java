...
// SDK
public class SdkZcRenderBulletRocket extends Render
{

    public SdkZcRenderBulletRocket()
    {
    }

    public void func_154_a(SdkZcEntityBullet entitybullet, double d, double d1, double d2, 
            float f, float f1)
    {
        loadTexture("/sdkzc/rockets.png");
        GL11.glPushMatrix();
    ...
    public void doRender(Entity entity, double d, double d1, double d2, 
            float f, float f1)
    {
        func_154_a((SdkZcEntityBullet)entity, d, d1, d2, f, f1);
    }
}
