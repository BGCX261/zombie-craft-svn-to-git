...
public class GuiSelectWorld extends GuiScreen
{
    ...
    public void initGui2()
    {
        ...
        controlList.add(new GuiButton(0, width / 2 + 4, height - 28, 125, 20, stringtranslate.translateKey("gui.cancel")));
        
		controlList.add(new GuiButton(99, width / 2 + 4 + 125, height - 28, 25, 20, stringtranslate.translateKey("Z")));
    ...
    {
		if (guiselectworld instanceof GuiSelectZombieWorld)
		{
			return ((GuiSelectZombieWorld)guiselectworld).worldList;
		}
    ...
    public int field_22101_l;
    private List field_22100_m;
    public GuiWorldSlot field_22099_n;
    private String field_22098_o;
    private String field_22097_p;
    public boolean field_22096_q;
