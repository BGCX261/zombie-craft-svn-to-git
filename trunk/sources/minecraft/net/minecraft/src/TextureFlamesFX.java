...
public class TextureFlamesFX extends TextureFX
{
    ...
    public TextureFlamesFX(int i)
    {
        ...
        field_1133_g = new float[1152];
        field_1132_h = new float[1152];
    }
    ...
    public void onTick()
    {
        for(int i = 0; i < 32; i++)
        {
            ...
            {
                int l = 18;
                float f1 = field_1133_g[i + ((j + 1) % 36) * 32] * (float)l;
                for(int i1 = i - 1; i1 <= i + 1; i1++)
                {
                    for(int k1 = j; k1 <= j + 1; k1++)
                    {
                        int i2 = i1;
                        int k2 = k1;
                        if(i2 >= 0 && k2 >= 0 && i2 < 32 && k2 < 36)
                        {
                            f1 += field_1133_g[i2 + k2 * 32];
                        }
                        l++;
                    }
                ...
                field_1132_h[i + j * 32] = f1 / ((float)l * 1.03F);
                if(j >= 35)
                {
                    field_1132_h[i + j * 32] = (float)(Math.random() * Math.random() * Math.random() * 4D + Math.random() * 0.10000000149011612D + 0.20000000298023224D);
                }
            }
