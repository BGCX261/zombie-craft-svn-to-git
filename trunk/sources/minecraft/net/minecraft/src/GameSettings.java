...
public class GameSettings
{
    ...
    public GameSettings(Minecraft minecraft, File file)
    {
        ...
        keyBindCharge = new KeyBinding("Charge", 16);
        keyBindings = (new KeyBinding[] {
            keyBindForward, keyBindLeft, keyBindBack, keyBindRight, keyBindJump, keyBindSneak, keyBindDrop, keyBindInventory, keyBindChat, keyBindToggleFog, keyBindCharge
        });
        difficulty = 2;
        field_22277_y = false;
    ...
    public void setOptionValue(EnumOptions enumoptions, int i)
    {
        ...
        if(enumoptions == EnumOptions.DIFFICULTY)
        {
            ...
            if (difficulty == 0) difficulty = difficulty + i & 3;
        }
    ...
    public void saveOptions()
    {
        try
        {
            ...
            printwriter.println((new StringBuilder("limitFramerate:")).append(limitFramerate).toString());
            ...
            printwriter.println((new StringBuilder("ao:")).append(field_22278_j).toString());
    ...
    public KeyBinding keyBindCharge;
