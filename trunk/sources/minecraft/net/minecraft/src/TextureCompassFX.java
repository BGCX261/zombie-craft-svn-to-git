...
public class TextureCompassFX extends TextureFX
{
    ...
    public TextureCompassFX(Minecraft minecraft)
    {
        ...
        try
        {
            ...
            bufferedimage.getRGB(i, j, 32, 32, field_4230_h, 0, 32);
        }
    ...
    public void onTick()
    {
        ...
        field_4229_i = field_4229_i + field_4228_j;
        double d3 = Math.sin(field_4229_i);
        double d5 = Math.cos(field_4229_i);
        for(int i2 = -8; i2 <= 8; i2++)
        {
            int k2 = (int)(16.5D + d5 * (double)i2 * 0.29999999999999999D);
            int i3 = (int)(15.5D - d3 * (double)i2 * 0.29999999999999999D * 0.5D);
            int k3 = i3 * 32 + k2;
            int i4 = 100;
            int k4 = 100;
            int i5 = 100;
        ...
        {
            int l2 = (int)(16.5D + d3 * (double)j2 * 0.29999999999999999D);
            int j3 = (int)(15.5D + d5 * (double)j2 * 0.29999999999999999D * 0.5D);
            int l3 = j3 * 32 + l2;
            int j4 = j2 < 0 ? 100 : 255;
            int l4 = j2 < 0 ? 100 : 20;
            int j5 = j2 < 0 ? 100 : 20;
