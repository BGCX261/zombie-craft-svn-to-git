    ...
    private void dispenseItem(World world, int i, int j, int k, Random random)
    {
        ...
        } else
        {
            ...
            if(itemstack.itemID == Item.arrow.shiftedIndex)
            {
                ...
                ((EntityArrow)entityarrow).setArrowHeading(f, 0.10000000149011611D, f1, 1.1F, 6F);
            ...
            if(itemstack.itemID == Item.egg.shiftedIndex)
            {
                ...
                ((EntityEgg)entityegg).func_20048_a(f, 0.10000000149011611D, f1, 1.1F, 6F);
            ...
            if(itemstack.itemID == Item.snowball.shiftedIndex)
            {
                ...
                ((EntitySnowball)entitysnowball).func_467_a(f, 0.10000000149011611D, f1, 1.1F, 6F);
            ...
            } else
            {
                ...
                ((EntityItem)entityitem).motionX = (double)f * d3;
                ((EntityItem)entityitem).motionY = 0.20000000298023221D;
                ((EntityItem)entityitem).motionZ = (double)f1 * d3;
