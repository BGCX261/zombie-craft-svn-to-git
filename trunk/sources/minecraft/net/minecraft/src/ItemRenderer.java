...
public class ItemRenderer
{
    ...
    public void renderItem(ItemStack itemstack)
    {
        ...
        } else
        {
            ...
            for(int i = 0; i < 32; i++)
            {
                float f9 = (float)i / 32F;
                float f13 = (f1 + (f - f1) * f9) - 0.0004882813F;
                float f17 = f4 * f9;
            ...
            for(int j = 0; j < 32; j++)
            {
                float f10 = (float)j / 32F;
                float f14 = (f1 + (f - f1) * f10) - 0.0004882813F;
            ...
            for(int k = 0; k < 32; k++)
            {
                float f11 = (float)k / 32F;
                float f15 = (f3 + (f2 - f3) * f11) - 0.0004882813F;
                float f19 = f4 * f11;
            ...
            for(int l = 0; l < 32; l++)
            {
                float f12 = (float)l / 32F;
                float f16 = (f3 + (f2 - f3) * f12) - 0.0004882813F;
                float f20 = f4 * f12;
