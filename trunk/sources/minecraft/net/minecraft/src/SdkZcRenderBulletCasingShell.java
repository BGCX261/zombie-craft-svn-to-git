...
// SDK
public class SdkZcRenderBulletCasingShell extends Render
{

    public SdkZcRenderBulletCasingShell()
    {
    }

    public void func_154_a(SdkZcEntityBulletCasing entitybulletcasing, double d, double d1, double d2, 
            float f, float f1)
    {
        loadTexture("/sdkzc/shells.png");
        GL11.glPushMatrix();
    ...
    public void doRender(Entity entity, double d, double d1, double d2, 
            float f, float f1)
    {
        func_154_a((SdkZcEntityBulletCasing)entity, d, d1, d2, f, f1);
    }
}
