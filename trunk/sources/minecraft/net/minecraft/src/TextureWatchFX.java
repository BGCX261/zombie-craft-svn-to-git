...
public class TextureWatchFX extends TextureFX
{
    ...
    public TextureWatchFX(Minecraft minecraft)
    {
        ...
        field_4224_h = new int[1024];
        field_4223_i = new int[1024];
        ...
        try
        {
            ...
            int i = (iconIndex % 16) * 32;
            int j = (iconIndex / 16) * 32;
            bufferedimage.getRGB(i, j, 32, 32, field_4224_h, 0, 32);
            bufferedimage = ImageIO.read((net.minecraft.client.Minecraft.class).getResource("/misc/dial.png"));
            bufferedimage.getRGB(0, 0, 32, 32, field_4223_i, 0, 32);
        }
    ...
    public void onTick()
    {
        ...
        field_4221_k = field_4221_k + d1 * 0.10000000000000001D;
        ...
        for(int i = 0; i < 1024; i++)
        {
            ...
            if(k == i1 && l == 0 && i1 > 0)
            {
                double d4 = -((double)(i % 32) / 31D - 0.5D);
                double d5 = (double)(i / 32) / 31D - 0.5D;
                int i2 = k;
                int j2 = (int)((d4 * d3 + d5 * d2 + 0.5D) * 32D);
                int k2 = (int)(((d5 * d3 - d4 * d2) + 0.5D) * 32D);
                int l2 = (j2 & 0x1f) + (k2 & 0x1f) * 32;
