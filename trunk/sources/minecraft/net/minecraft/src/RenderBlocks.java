...
public class RenderBlocks
{
    ...
    public boolean func_22330_a(Block block, int i, int j, int k, float f, float f1, float f2)
    {
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j - 1, k, 0))
        {
            ...
            if(field_22352_G > 0)
            {
                ...
                j++;
                f3 = (field_22375_o + field_22376_n + field_22373_q + field_22382_h) / 4F;
                f21 = (field_22373_q + field_22382_h + field_22370_t + field_22371_s) / 4F;
                f15 = (field_22382_h + field_22374_p + field_22371_s + field_22372_r) / 4F;
                f9 = (field_22376_n + field_22377_m + field_22382_h + field_22374_p) / 4F;
            } else
            {
                f3 = f9 = f15 = f21 = field_22382_h;
            }
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j + 1, k, 1))
        {
            ...
            if(field_22352_G > 0)
            {
                ...
                j--;
                f22 = (field_22367_w + field_22368_v + field_22362_A + field_22379_k) / 4F;
                f4 = (field_22362_A + field_22379_k + field_22360_B + field_22364_z) / 4F;
                f10 = (field_22379_k + field_22366_x + field_22364_z + field_22365_y) / 4F;
                f16 = (field_22368_v + field_22369_u + field_22379_k + field_22366_x) / 4F;
            } else
            {
                f4 = f10 = f16 = f22 = field_22379_k;
            }
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k - 1, 2))
        {
            ...
            if(field_22352_G > 0)
            {
                ...
                k++;
                f5 = (field_22358_C + field_22369_u + field_22381_i + field_22366_x) / 4F;
                f11 = (field_22381_i + field_22366_x + field_22356_D + field_22365_y) / 4F;
                f17 = (field_22374_p + field_22381_i + field_22372_r + field_22356_D) / 4F;
                f23 = (field_22377_m + field_22358_C + field_22374_p + field_22381_i) / 4F;
            } else
            {
                f5 = f11 = f17 = f23 = field_22381_i;
            }
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i, j, k + 1, 3))
        {
            ...
            if(field_22352_G > 0)
            {
                ...
                k--;
                f6 = (field_22354_E + field_22367_w + field_22378_l + field_22362_A) / 4F;
                f24 = (field_22378_l + field_22362_A + field_22353_F + field_22360_B) / 4F;
                f18 = (field_22373_q + field_22378_l + field_22370_t + field_22353_F) / 4F;
                f12 = (field_22375_o + field_22354_E + field_22373_q + field_22378_l) / 4F;
            } else
            {
                f6 = f12 = f18 = f24 = field_22378_l;
            }
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i - 1, j, k, 4))
        {
            ...
            if(field_22352_G > 0)
            {
                ...
                i++;
                f25 = (field_22376_n + field_22375_o + field_22383_g + field_22354_E) / 4F;
                f7 = (field_22383_g + field_22354_E + field_22368_v + field_22367_w) / 4F;
                f13 = (field_22358_C + field_22383_g + field_22369_u + field_22368_v) / 4F;
                f19 = (field_22377_m + field_22376_n + field_22358_C + field_22383_g) / 4F;
            } else
            {
                f7 = f13 = f19 = f25 = field_22383_g;
            }
        ...
        if(renderAllFaces || block.shouldSideBeRendered(blockAccess, i + 1, j, k, 5))
        {
            ...
            if(field_22352_G > 0)
            {
                ...
                i--;
                f8 = (field_22371_s + field_22370_t + field_22380_j + field_22353_F) / 4F;
                f26 = (field_22380_j + field_22353_F + field_22364_z + field_22360_B) / 4F;
                f20 = (field_22356_D + field_22380_j + field_22365_y + field_22364_z) / 4F;
                f14 = (field_22372_r + field_22371_s + field_22356_D + field_22380_j) / 4F;
            } else
            {
                f8 = f14 = f20 = f26 = field_22380_j;
            }
    ...
    private static final boolean field_22004_GRASSFIX = false;
}
